export const tweets = [
  ...
  },
  {
    ...
    tweet:
      'Toys stay finch polydactyl stay barky bark pet supplies food Buddy chirp Spike nap stick dog house throw.Tail collar leash Rover meow catch Scooby snacks.',
    user_type: 'friend',
  },
  {
    id: 5,
    ...
    tweet:
      'Kitty bark string shake litter box toys polydactyl yawn polydactyl scratcher water dog stay cage nest slobber chirp water.',
    user_type: 'friend',
  },
  {
    id: 6,
    ...
    tweet:
      'Birds fur collar fluffy collar parakeet barky dog house run sit Buddy purr. Bird wag tail small animals groom vitamins Tigger.',
    user_type: 'friend',
  },
]
